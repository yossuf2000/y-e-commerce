                      ...
                      children: [
                        Align(
                          ...
                          child: Container(
                            ...
                            child: Image.network(
                              'https://images.unsplash.com/photo-1485808191679-5f86510681a2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxNHx8Y29mZmVlfGVufDB8fHx8MTcxNjQwODUzMHww&ixlib=rb-4.0.3&q=80&w=1080',
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                                  ...
                                  Padding(
                                    ...
                                    child: SingleChildScrollView(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          wrapWithModel(
                                            model: _model.addComponantModel1,
                                            updateCallback: () =>
                                                setState(() {}),
                                            child: const AddComponantWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.addComponantModel2,
                                            updateCallback: () =>
                                                setState(() {}),
                                            child: const AddComponantWidget(),
                                          ),
                                          wrapWithModel(
                                            model: _model.addComponantModel3,
                                            updateCallback: () =>
                                                setState(() {}),
                                            child: const AddComponantWidget(),
                                          ),
